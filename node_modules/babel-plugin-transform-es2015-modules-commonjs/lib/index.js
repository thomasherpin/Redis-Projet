        ...
        exit: function exit(path) {
            ...
            if (_path.isImportDeclaration()) {
              ...
              if (declaration.node) {
                if (declaration.isFunctionDeclaration()) {
                  ...
                  for (var _iterator5 = declarators, _isArray5 = Array.isArray(_iterator5), _i5 = 0, _iterator5 = _isArray5 ? _iterator5 : _getIterator(_iterator5);;) {
                    var _ref5;
          ...
          for (var source in imports) {
            ...
            if (specifiers.length) {
              ...
              for (var _iterator8 = specifiers, _isArray8 = Array.isArray(_iterator8), _i8 = 0, _iterator8 = _isArray8 ? _iterator8 : _getIterator(_iterator8);;) {
                var _ref8;
